...
async function zu(t) {
  if (ec2(t)) for (const e of t.Ru) await e(
    /* enabled= */
    true
  );
}
...
var $c2 = class {
  ...
  async complete() {
    ...
    for (const t2 of this.queries) await gu(this.localStore, t2, e.get(t2.name));
...
async function jc2(t, e) {
  ...
  } else na2(n, s.targetId), await lu(
    n.localStore,
    s.targetId,
    /*keepPersistedTargetData=*/
    true
...
function Ta2(t, e, n) {
  ...
  (async function(t2, e2, n2) {
    try {
      ...
      }(t2.localStore, s2)) return await e2.close(), n2._completeWith(function(t3) {
        return {
          taskState: "Success",
...
async function $a2(t) {
  ...
  } else N2("FirestoreClient", "Using default OfflineComponentProvider"), await Na2(t, new Ea());
